...
public class HumanPlayer extends Player
{
    ...
    //Loads guesses from a text file
    ...
    {
        //If we have pre-supplied guesses from a file, use them first
        ...
        //Fallback to manual entry if file guesses run out or were never loaded
        String guess;
        while (true)
        {
